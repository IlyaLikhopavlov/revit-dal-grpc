...
namespace App.Catalog.Db.Migrations
{
    ...
    [Migration("20230405031737_AddedPowerType")]
    partial class AddedPowerType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Catalog.Db.Model.PowerType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("App.Catalog.Db.Model.BarCatalog", b =>
                {
                    b.HasOne("App.Catalog.Db.Model.PowerType", "PowerType")
                        .WithMany("BarCatalogs")
            ...
            modelBuilder.Entity("App.Catalog.Db.Model.PowerType", b =>
                {
                    b.Navigation("BarCatalogs");

                    b.Navigation("FooCatalogs");
                });
